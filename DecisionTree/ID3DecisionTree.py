...
class ID3Model:
    ...
    def create_tree(self, df, features):
        ...
        if len(features) == 0:
            ...
            # make a leaf for every missing value so the testing data always has a target
            ...
            missing_values = pd.DataFrame(pd.concat([missing_values[0],
                                                     missing_values[1]],
